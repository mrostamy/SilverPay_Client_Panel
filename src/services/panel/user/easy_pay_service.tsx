...
export class EasyPayService {
    ...
    getEasyPayGatesWallets = (id: string,easyPayId:string): Promise<easyPayGatesWallets> => {

        return axios.get(this.base_url + "users/" + id + "/easyPays"+easyPayId+"/gatesWallets/");
    ...
    addeasyPay = (easyPay: any, userId: string): Promise<easyPay> => {
